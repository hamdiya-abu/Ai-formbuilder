    ...
    {Themes.map((theme,index)=>(
       ...
       <div className='grid grid-cols-3 gap-5'>
        {GradientBg.map((bg,index)=>(index<showMore)&&(
            ...
            className='w-full h-[70px] rounded-lg hover:border-black
             hover:border-2 flex items-center cursor-pointer justify-center'
        ...
        onClick={()=>setShowMore(showMore>6?6:15)}>{showMore>6?'Show Less':'Show More'}</Button>
